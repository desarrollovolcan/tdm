                                        ...
                                        <div class="col-xl-12">
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        <h4 class="fs-20 mb-1">Usuarios y roles</h4>
                                                                        <span class="fs-14 text-muted">Configura accesos, perfiles y permisos del personal</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Configura accesos, perfiles y permisos del personal</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
