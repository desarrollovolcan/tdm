                                                ...
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        ...
                                                                        <span class="fs-14 text-muted">Controla el estado de cada partido y sus incidencias</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Controla el estado de cada partido y sus incidencias</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
