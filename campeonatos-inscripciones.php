                                                ...
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        ...
                                                                        <span class="fs-14 text-muted">Administra las inscripciones individuales y por equipos</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Administra las inscripciones individuales y por equipos</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
