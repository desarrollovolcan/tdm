									...
									<table class="table table-sm mb-0 table-responsive-lg">
										...
										<tbody id="orders">
											...
											<tr class="btn-reveal-trigger">
												...
												<td class="py-2 border-bottom-0">28/04/2020</td>
												<td class="py-2 border-bottom-0">Jennifer Johnson, Rhyd Y Groes, Rhosgoch, LL66 0AT
													<p class="mb-0 text-500 border-bottom-0">Via Flat Rate</p>
												</td>
												<td class="py-2 text-end border-bottom-0"><span
														class="badge badge-primary">Processing<span
															class="ms-1 fa fa-redo"></span></span>
												</td>
												<td class="py-2 text-end border-bottom-0">$112
												</td>
												<td class="py-2 text-end border-bottom-0">
													<div class="dropdown text-sans-serif"><button
															class="btn btn-primary tp-btn-light sharp" type="button"
