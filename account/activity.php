					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
						<ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0"
							...
							<li class="nav-item ms-1" role="presentation">
								<a href="account/overview.php" class="nav-link py-3 border-3 text-black">Overview</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/settings.php" class="nav-link py-3 border-3 text-black">Settings</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/security.php" class="nav-link py-3 border-3 text-black">Security</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/activity.php"
									class="nav-link py-3 border-3 text-black active">Activity</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/billing.php" class="nav-link py-3 border-3 text-black">Billing</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/statements.php"
									class="nav-link py-3 border-3 text-black">Statements</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/referrals.php" class="nav-link py-3 border-3 text-black">Referrals</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/api-keys.php" class="nav-link py-3 border-3 text-black">API Keys</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
								<a href="account/logs.php" class="nav-link py-3 border-3 text-black">Logs</a>
							</li>
						</ul>
											...
											<div class="widget-timeline-status">
												<ul class="timeline">
													...
													<li>
														...
														<div class="timeline-panel">
															<span class="fs-14 fw-semibold">Video Sharing</span>
														</div>
													</li>
													<li>
														...
														<div class="timeline-panel">
															<span class="fs-14 fw-semibold">john just buy your product
													...
													<li>
														...
														<div class="timeline-panel">
															<span class="fs-14 fw-semibold">StumbleUpon is acquired by
						...
						<div class="col-xxl-9 col-xl-8">
							<div class="card">
								<div class="card-header py-3 d-block d-sm-flex">
									...
									<ul class="nav nav-pills mt-3 mt-sm-0 mix-chart-tab" id="myTab" role="tablist">
										<li class="nav-item ms-1" role="presentation">
											...
											<div class="widget-timeline-icons pb-3">
												<ul class="timeline">
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold">StumbleUpon is acquired
																	by eBay.</span>
																...
																<div class="row align-items-center">
																	...
																	<div
																		...
																		<a href="javascript:void(0);"
																			class="btn btn-xxs btn-light text-black">View</a>
																	</div>
																</div>
															</div>
															<div
													...
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold">Mashable, a news website
																	and blog, goes live</span>
													...
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold">05 New Project Files
																	Uploaded</span>
																...
																<div class="row g-3">
																	<div class="col-lg-3 col-sm-6">
																		<div class="d-flex align-items-center">
																			<div class="me-3">
																				<img src="assets/images/files/pdf.png"
																					width="35" alt="">
																			</div>
																			<div class="clearfix">
																	...
																	<div class="col-lg-3 col-sm-6">
																		<div class="d-flex align-items-center">
																			<div class="me-3">
																				<img src="assets/images/files/csv.png"
																					width="35" alt="">
																			</div>
																			<div class="clearfix">
																	...
																	<div class="col-lg-3 col-sm-6">
																		<div class="d-flex align-items-center">
																			<div class="me-3">
																				<img src="assets/images/files/css.png"
																					width="35" alt="">
																			</div>
																			<div class="clearfix">
													...
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold"><a
													...
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold"><strong>Hughes</strong>
													...
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold">3 Dashboard concepts
																	uploaded</span>
															...
															<div
																...
																<div class="row g-3">
																	<div class="col-md-2 col-4">
																		<img src="assets/images/blog/screen1.jpg" alt=""
																			class="w-100 rounded">
																	</div>
																	<div class="col-md-2 col-4">
																		<img src="assets/images/blog/screen2.jpg" alt=""
																			class="w-100 rounded">
																	</div>
																	<div class="col-md-2 col-4">
																		<img src="assets/images/blog/screen3.jpg" alt=""
																			class="w-100 rounded">
																	</div>
																</div>
															</div>
													...
													<li>
														...
														<div class="timeline-panel">
															<div class="clearfix">
																<span class="fs-14 fw-semibold">You have received your
																	monthly Affiliate Fee</span>
