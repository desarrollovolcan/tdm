                                        ...
                                        <div class="col-xl-12">
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        <h4 class="fs-20 mb-1">Sedes, mesas y recursos</h4>
                                                                        <span class="fs-14 text-muted">Controla sedes, mesas disponibles y equipamiento</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Controla sedes, mesas disponibles y equipamiento</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
