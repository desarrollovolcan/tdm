                                        ...
                                        <div class="col-xl-12">
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        <h4 class="fs-20 mb-1">Historial de participación</h4>
                                                                        <span class="fs-14 text-muted">Consulta historiales, sanciones y resultados previos</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Consulta historiales, sanciones y resultados previos</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
