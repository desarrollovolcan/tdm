				...
				<div class="card profile-overview">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
						<ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0"
							...
							<li class="nav-item ms-1" role="presentation">
								<a href="account/logs.php" class="nav-link py-3 border-3 text-black active">Logs</a>
							</li>
						</ul>
											...
											<tbody>
												<tr>
													...
													<td><a href="javascript:void(0);"
															class="text-primary">POST/project/yashadmin/5482344/not_found</a>
													</td>
												...
												<tr>
													...
													<td><a href="javascript:void(0);"
															class="text-primary">POST/project/yashadmin/5482344/invalid</a>
													</td>
												...
												<tr>
													...
													<td><a href="javascript:void(0);"
															class="text-primary">POST/project/yashadmin/5482344/payment</a>
													</td>
													<td class="text-end">20 Dec 2024, 2:40 pm</td>
												</tr>
												<tr>
