				...
				<div class="card profile-overview">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
						<ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0"
							...
							<li class="nav-item ms-1" role="presentation">
								<a href="account/activity.php" class="nav-link py-3 border-3 text-black">Activity</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
							...
							<li class="nav-item ms-1" role="presentation">
								<a href="account/api-keys.php" class="nav-link py-3 border-3 text-black active">API
									Keys</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
										...
										<table
											...
											<tbody>
												<tr>
													...
													<td>
														<span
															class="badge badge-sm badge-success light border-0">Active</span>
													</td>
													<td class="text-end">
														<div class="dropdown">
												...
												<tr>
													...
													<td>
														<span
															class="badge badge-sm badge-info light border-0">Review</span>
													</td>
													<td class="text-end">
														<div class="dropdown">
															<button class="btn btn-sm btn-light dropdown-toggle"
												...
												<tr>
													...
													<td>
														<span
															class="badge badge-sm badge-danger light border-0">Inactive</span>
													</td>
													<td class="text-end">
														<div class="dropdown">
															<button class="btn btn-sm btn-light dropdown-toggle"
							...
							<div class="card">
								...
								<div class="card-body p-0">
									<div class="clearfix border-bottom p-4 border-dark border-opacity-10">
										...
										<p class="fs-14">Elevate your post: Integrate images for impact, smooth flow,
											humor, and clarity on complex subjects</p>
										<a href="javascript:void(0);" class="btn btn-light text-dark">Get Started</a>
									</div>
									<div class="clearfix p-4">
										<h6>Developer Tools</h6>
										<p class="fs-14">Craft your blog post: Choose a topic, outline, research, and
											fact-check diligently.</p>
										<a href="javascript:void(0);" class="btn btn-light text-dark">Create CLI
											Rule</a>
									</div>
								</div>
							</div>
