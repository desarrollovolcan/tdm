        ...
        <div class="container">
            <div class="row justify-content-center h-100 align-items-center">
                <div class="inner-content col-xl-12 text-center">
					<h1 class="error-head">503</h1>
					<h3 class="error-para">Service Unavailable</h3>
					<p>Sorry, 😭 we are under maintenance!.</p>
					<a href="index.php" class="btn btn-md btn-secondary btn-hover-1"><span>Back to Home</span></a>
				</div>
            </div>
        </div>
    </div>
