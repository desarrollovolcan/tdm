                ...
                <div class="row">
                    <div class="col-12">
					 ...
					 <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Datatable Buttons</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table id="example3" class="display" style="min-width: 850px">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="javascript:void(0);"><strong class="text-black">info@example.com</strong></a></td>
                                                <td>2011/04/25</td>
                                                <td>
													<div class="d-flex">
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic2.jpg" alt="/"></td>
                                                <td>Garrett Winters</td>
                                                <td>Accountant</td>
                                                <td>Female</td>
                                                <td>M.COM., P.H.D.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic3.jpg" alt="/"></td>
                                                <td>Ashton Cox</td>
                                                <td>Junior Technical</td>
                                                <td>Male</td>
                                                <td>B.COM., M.COM.</td>
                                                <td><a href="javascript:void(0);"><strong class="text-black">(123) 4567 890</strong></a></td>
												<td><a href="javascript:void(0);"><strong class="text-black">info@example.com</strong></a></td>
                                                <td>2009/01/12</td>
												<td>
													<div class="d-flex">
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic4.jpg" alt="/"></td>
                                                <td>Cedric Kelly</td>
                                                <td>Developer</td>
                                                <td>Male</td>
												<td>B.COM., M.COM.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic5.jpg" alt="/"></td>
                                                <td>Airi Satou</td>
                                                <td>Accountant</td>
                                                <td>Female</td>
												<td>B.A, B.C.A</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic6.jpg" alt="/"></td>
                                                <td>Brielle Williamson</td>
                                                <td>Specialist</td>
                                                <td>Male</td>
												<td>B.COM., M.COM.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic7.jpg" alt="/"></td>
                                                <td>Herrod Chandler</td>
                                                <td>Sales Assistant</td>
                                                <td>Female</td>
												<td>B.A, B.C.A</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic8.jpg" alt="/"></td>
                                                <td>Rhona Davidson</td>
                                                <td>Integration</td>
                                                <td>Male</td>
												<td>B.TACH, M.TACH</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic9.jpg" alt="/"></td>
                                                <td>Colleen Hurst</td>
                                                <td>Javascript Developer</td>
                                                <td>Female</td>
												<td>B.A, B.C.A</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="assets/images/profile/small/pic10.jpg" alt="/"></td>
                                                <td>Sonya Frost</td>
                                                <td>Software Engineer</td>
                                                <td>Male</td>
												<td>B.COM., M.COM.</td>
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example4" class="display" style="min-width: 850px">
                                        <thead>
                                            <tr>
                                                <th>Roll No</th>
                                                <th>Student Name</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>2011/04/25</td>
                                                <td><strong class="text-black">120$</strong></td>
                                            </tr>
                                            <tr>
												<td>02</td>
                                                <td>Garrett Winters</td>
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example5" class="display" style="min-width: 850px">
                                        <thead>
                                            <tr>
                                                <th>
