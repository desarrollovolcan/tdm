                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <p>Select2 also supports multi-value select boxes. The select below is declared with the multiple <code class="text-danger">attribute</code>.</p>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="mb-4 select2-label" for="id_label_single">
                                    <span class="mb-2 d-block">Click this to highlight the single select element <br></span>

                                    <select class="select2-with-label-single js-states d-block mt-2" style="width:100%;" id="id_label_single">
                                        <option value="AL">Alabama</option>
                                        <option value="WY">Wyoming</option>
                                    </select>
                                </label>
                                ...
                                <label class="select2-label" for="id_label_multiple">
                                    <span  class="mb-2 d-block">Click this to highlight the multiple select element <br></span>
