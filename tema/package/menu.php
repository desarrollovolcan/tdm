								...
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col-xl-3 col-xxl-3 col-lg-4 mb-lg-0 mb-3">
											<h6 class="mb-0">Select a menu to edit:</h6>
										</div>
																	...
																	<form>
																		<div class="row">
																			...
																			<div class="d-flex align-items-center">
																				<a class="remove" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																...
																<div class="accordion-body">
																	<form>
																		<div class="row">
																			...
																			<div class="d-flex align-items-center">
																				<a class="remove" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																				<a class="text-hover cancel" href="javascript:void(0);"   data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
																				Cancel
																				</a>
																			</div>
																		</div>		
