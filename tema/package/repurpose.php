...
<body>
    ...
    ***********************************-->
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
						  ...
						  <li class="nav-item" role="presentation">
							<a href="repurpose.php" class="nav-link active">Repurpose</a>
						  </li>
						  <li class="nav-item" role="presentation">
						...
						<div class="card h-auto">
							<div class="card-body ai-tabs-1 py-2">
								<ul class="nav nav-tabs align-items-end" id="myTab" role="tablist">
								  <li class="nav-item" role="presentation">
									<button class="nav-link active" id="create-tab" data-bs-toggle="tab" data-bs-target="#create-tab-pane" type="button" role="tab" aria-controls="create-tab-pane" aria-selected="true">Create Fine-tune Job</button>
								  </li>
								  <li class="nav-item" role="presentation">
									<button class="nav-link" id="jobs-tab" data-bs-toggle="tab" data-bs-target="#jobs-tab-pane" type="button" role="tab" aria-controls="jobs-tab-pane" aria-selected="false">Jobs<span class="badge badge-circle badge-light light ms-2">5</span></button>
								  </li>
										...
										<div class="card-body pb-3">
											...
											<div class="row">
												<div class="col-xl-12">
													...
													<label for="exampleFormControlInput2" class="form-label">Post type</label>
													<div class="mb-3">
	...
	Title:
													...
													<div class="mb-3">
													  <textarea class="form-control bg-transparent border" id="exampleFormControlTextarea7" rows="3">
	Generate a title for an article that discusses the following topic:
	[[description]]
	The article will include the following sections:
	[[section-headlines]]
								...
								<div class="card-body p-0">
									<div class="table-responsive active-projects style-1">
										<table id="empoloyees-tblwrapper" class="table">
											...
											<tbody>
												<tr>
													<td style= "width:50%;"><a href="javascript:void(0);">www.wsj.com/articles/harvard-discriminates-against-middle-class-kids-legacy-admissions-court-85cf4503</a></td>
													<td>
														URL
													</td>
													
													<td>-</td>
													<td><span class="badge badge-light">No</span></td>
													<td><span class="badge badge-light">No</span></td>
