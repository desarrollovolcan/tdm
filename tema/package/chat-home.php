			...
			<div class="container-fluid mh-auto p-0">
				<div class="row gx-0">
					<div class="col-xl-3 col-xxl-4 col-md-5 chat-left-area">
						<div class="card dz-scroll chat-sidebar rounded-0 mb-0" id="chat-sidebar">
							<div class="card-header border-0 pb-0">
								<h4 class="card-title">Chat</h4>
							</div>
							<div class="card-body">
								<div class="message-box d-flex align-items-center justify-content-between pt-0">
									...
									<a class="icon-bx bg-primary c-pointer" data-bs-toggle="modal" data-bs-target="#exampleModal">
								...
								<div class="chat-tabs">
									<div>
										<ul>
											<li class="chat-bx">
												<div>
													<img src="assets/images/avatar/1.jpg" class="avatar  me-3" alt="">
												</div>
												<div class="mid-info">
													<h4 class="card-title card-title--small mb-1">Product Team (32)</h4>
											...
											<li class="chat-bx">
												<div>
													<img src="assets/images/avatar/2.jpg" class="avatar me-3" alt="">
												</div>
												<div class="mid-info">
													<h4 class="card-title card-title--small mb-1">Tony Soap</h4>
													<p class="mb-0">Lorem ipsum dolor sit 🤔.</p>
												</div>
												<div class="ms-auto">
													<small>12:45 PM</small>
											...
											<li class="chat-bx ">
												<div>
													<img src="assets/images/avatar/3.jpg" class="avatar me-3" alt="">
												</div>
												<div class="mid-info">
													<h4 class="card-title card-title--small mb-1">Karen Hope</h4>
										...
										<ul>
											<li class="chat-bx chats">
												<div class="Position-realtive">
													<img src="assets/images/avatar/4.jpg" class="avatar me-3" alt="">
												</div>
												<div class="mid-info">
													<h4 class="card-title card-title--small mb-1">Design Team (32)</h4>
													<p class="mb-0">Lorem ipsum dolor sit amet.</p>
												</div>
												<div class="ms-auto">
													<small>12:45 PM</small>
											...
											<li class="chat-bx chats">
												<div>
													<img src="assets/images/avatar/5.jpg" class="avatar me-3" alt="">
												</div>
												<div class="mid-info">
													<h4 class="card-title card-title--small mb-1">Tony Soap</h4>
													<p class="mb-0">Lorem ipsum dolor sit amet.</p>
											...
											<li class="chat-bx chats">
												<div class="">
													<img src="assets/images/avatar/6.jpg" class="avatar me-3" alt="">
												</div>
												<div class="mid-info">
													<h4 class="card-title card-title--small">Karen Hope</h4>
													<p class="mb-0">Lorem ipsum dolor sit 👍.</p>
												</div>
												<div class="ms-auto">
													<small>12:45 PM</small>
					...
					<!--column-->
					<div class="col-xl-9 col-xxl-8 col-md-7 chat-mid-area">
						<div class="message-box style-1 d-flex align-items-center">
							...
							<div class="chat-hamburger">
								...
								<div class="videos-player">
									<a href="javascript:void(0);" class="icon-bx icon-bx-sm bg-secondary me-3">
								...
								<div class="media my-4">
									...
									<div class="message-received w-auto">
										...
										<div >
											...
											<small class="text-primary">12:45 PM</small>
										</div>
									</div>
								</div>
								...
								<div class="media my-4">
									...
									<div class="message-received w-auto">
										...
										<div >
											...
											<div class="dz-media">
												<img src="assets/images/chat-home.jpg" alt="">
											</div>
											<small class="text-primary">12:45 PM</small>
										</div>
									</div>
