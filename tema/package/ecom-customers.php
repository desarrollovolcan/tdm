                                    ...
                                    <table class="table table-sm mb-0 table-striped">
                                        ...
                                        <tbody id="customers">
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2 border-bottom-0"><a
                                                        href="mailto:cadena@example.com">info@example.com</a></td>
                                                <td class="py-2 border-bottom-0"> <a href="tel:3172737814">(317) 273-7814</a></td>
                                                <td class="py-2 ps-5 border-bottom-0">3412 Crestview Manor, Indianapolis</td>
                                                <td class="py-2 border-bottom-0">15/04/2015</td>
