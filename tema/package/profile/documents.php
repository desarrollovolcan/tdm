							...
							<div class="clearfix pe-md-5">
								...
								<div class="d-md-flex d-none flex-wrap">
									<div class="border outline-dashed rounded p-2 d-flex align-items-center me-3 mt-3">
										<div
											class="avatar  style-1 bg-primary-light text-primary rounded d-flex align-items-center justify-content-center">
					...
					<div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center px-0">
						<ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0"
							...
							<li class="nav-item ms-1" role="presentation">
								<a href="profile/overview-profile.php" class="nav-link py-3 border-3 text-black">Overview</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
							...
							<li class="nav-item ms-1" role="presentation">
								<a href="profile/documents.php"
									class="nav-link py-3 border-3 text-black active">Documents</a>
							</li>
							<li class="nav-item ms-1" role="presentation">
				...
				<div class="tab-content" id="tabContentMyProfileBottom">
					<div class="d-flex justify-content-between align-items-center mb-3">
						...
						<div class="d-flex align-items-center">
							<ul class="nav nav-pills" id="myTabView" role="tablist">
								<li class="nav-item ms-1" role="presentation">
									<button class="nav-link btn btn-light btn-sharp p-0 active" id="project-list-tab"
										data-bs-toggle="tab" data-bs-target="#project-list-pane" type="button"
										role="tab" aria-controls="project-list-pane" aria-selected="true">
								...
								<li class="nav-item ms-1" role="presentation">
									<button class="nav-link btn btn-light btn-sharp p-0" id="project-grid-tab"
										data-bs-toggle="tab" data-bs-target="#project-grid-pane" type="button"
										role="tab" aria-controls="project-grid-pane" aria-selected="false">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
											viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
					...
					<div class="tab-content" id="myTabContentView">
						<div class="tab-pane fade show active" id="project-list-pane" role="tabpanel"
							aria-labelledby="project-list-tab" tabindex="0">
							<div class="row">
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/folder.png" width="45" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">CRUD Invoices</h6>
												<span class="fs-14">12 files</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											...
											<div class="clearfix">
												<h6 class="mb-0">Tower Hill Docs</h6>
												<span class="fs-14">17 files</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/folder.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Leaf CRM API Co..</h6>
												<span class="fs-14">21 days ago</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/csv.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Tower Hill bilboa..</h6>
												<span class="fs-14">34 days ago</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/css.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Orders backup</h6>
												<span class="fs-14">03 days ago</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/pdf.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Avionica Tech.</h6>
												<span class="fs-14">04 days ago</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/html.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">9 Degree CRUD.</h6>
												<span class="fs-14">10 days ago</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/ppt.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">User CRUD Styles</h6>
												<span class="fs-14">78 days ago</span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-xxl-2 col-xl-3 col-md-4 col-sm-6">
									<div class="card">
										<div class="card-body px-4 py-3 d-flex align-items-center gap-3">
											<div>
												<img src="assets/images/files/mp3.png" width="35" alt="">
											</div>
											<div class="clearfix">
												<h6 class="mb-0">Craft Logo</h6>
												<span class="fs-14">65 days ago</span>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="tab-pane fade" id="project-grid-pane" role="tabpanel"
							aria-labelledby="project-grid-tab" tabindex="0">
							<div class="row">
									...
									<div class="card">
										<div
											...
											<div class="m-auto pb-3">
												<img src="assets/images/files/folder.png" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xl-2 col-lg-4 col-sm-6">
									<div class="card">
										<div
											class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="assets/images/files/csv.png" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xl-2 col-lg-4 col-sm-6">
									<div class="card">
										<div
											class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="assets/images/files/css.png" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xl-2 col-lg-4 col-sm-6">
									<div class="card">
										<div
											class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="assets/images/files/pdf.png" alt="">
											</div>
											<div class="clearfix">
												<h5 class="mb-0">Avionica Tech Req..</h5>
												<span class="fs-14">2 days ago</span>
											</div>
										</div>
									</div>
								...
								<div class="col-xl-2 col-lg-4 col-sm-6">
									<div class="card">
										<div
											class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="assets/images/files/html.png" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xl-2 col-lg-4 col-sm-6">
									<div class="card">
										<div
											class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="assets/images/files/ppt.png" alt="">
											</div>
											<div class="clearfix">
								...
								<div class="col-xl-2 col-lg-4 col-sm-6">
									<div class="card">
										<div
											class="card-body text-center p-4 d-flex flex-column justify-content-between">
											<div class="m-auto pb-3">
												<img src="assets/images/files/mp3.png" alt="">
											</div>
											<div class="clearfix">
