					...
					<div class="col-xl-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form>
										<select class="default-select form-control wide form-control-lg mb-3">
                                ...
                                <div class="basic-form">
                                    <form>
                                        <div class="mb-3 mb-0">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="gridRadios" value="option2" checked>
												<label class="form-check-label">
													Option 2
												</label>
											</div>
											<div class="form-check">
                                                <input class="form-check-input" type="radio" name="gridRadios" value="option3" checked>
												<label class="form-check-label">
													Option 3
												</label>
											</div>
                                    ...
                                    <form action="#">
                                        <div class="input-group mb-3">
											<div class="input-group-text">
												<input type="checkbox" class="form-check-input" id="check-100" value="option1">
											</div>
                                            <input type="text" class="form-control">
                                        </div>
