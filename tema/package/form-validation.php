                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="validationCustom08" placeholder="212-999-0000" required>
														<div class="invalid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="validationCustom09"  placeholder="5" required>
														<div class="invalid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="validationCustom10" placeholder="5.0" required>
														<div class="invalid-feedback">
															Please enter a num.
														</div>
                                                    </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="validationCustom11" placeholder="4" required>
														<div class="invalid-feedback">
