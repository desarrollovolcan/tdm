                ...
                <div class="row">
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body p-0">
                                <div id="DZ_W_TimeLine" class="widget-timeline dz-scroll p-4 height370">
                                    <ul class="timeline">
                                        <li>
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body p-0">
                                <div id="DZ_W_TimeLine11" class="widget-timeline dz-scroll p-4 style-1 height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-badge primary"></div>
                                            <a class="timeline-panel text-muted" href="#">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body p-0"> 
                                <div id="DZ_W_Todo1" class="widget-media dz-scroll p-4 height370">
                                    <ul class="timeline">
                                        <li>
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card overflow-hidden border-0 pb-0">
                            <div class="card-header border-0 pb-0">
                                <h4 class="card-title">Notifications 2</h4>
                            </div>
                            <div class="card-body p-0"> 
                                <div id="DZ_W_Todo2" class="widget-media dz-scroll p-4 height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
												<div class="media me-2">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card overflow-hidden border-0 pb-0">
                            ...
                            <div class="card-body p-0"> 
                                <div id="DZ_W_Todo3" class="widget-media p-4 dz-scroll height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
												<div class="media me-2">
					...
					<div class="col-xl-4 col-xxl-6 col-lg-6">
                        <div class="card overflow-hidden border-0 pb-0">
                            ...
                            <div class="card-body p-0"> 
                                <div id="DZ_W_Todo4" class="widget-media dz-scroll p-4 height370">
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel">
					...
					<div class="col-xl-8 col-xxl-8 col-lg-12 col-sm-12">
                        <div id="user-activity" class="card">
                            <div class="card-header border-0 pb-0 d-sm-flex d-block">
                                ...
                                <div class="card-tabs mb-sm-0 my-2">
