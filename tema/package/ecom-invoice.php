            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card mt-3">
                            <div class="card-header"> Invoice <strong>01/02/2024</strong> <span class="float-end">
                            ...
                            <div class="card-body">
                                <div class="row mb-5">
                                    ...
                                    <div class="mt-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-lg-end  justify-content-xs-start">
