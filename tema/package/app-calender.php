                    ...
                    <div class="modal fade none-border" id="add-category">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control default-select" data-placeholder="Choose a color..." name="category-color">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default waves-effect btn-danger light" data-bs-dismiss="modal">Close</button>
