			...
			<div class="container-fluid">
				<div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Job Application</a></li>
					</ol>
                </div>
				<div class="row">
					...
					<div class="col-xl-8 col-xxl-6 col-lg-6 col-12 d-md-flex job-title-search pe-0">
						...
						<div class="input-group search-box">
							...
							<a href="javascript:void(0);" class="btn btn-primary rounded">Search<i class="flaticon-381-search-2 d-inline-block"></i></a>
						</div>
					</div>
				</div>
									...
									<div class="col-xl-12">
										<div class="d-flex flex-wrap search-row bg-white py-3 mb-3 rounded justify-content-between align-items-center">
											<div class="d-flex col-xl-4 col-xxl-5 col-md-5 col-sm-6 align-items-center">
												...
												<div>
													<h2 class="card-title--medium mb-1"><a href="app-profile.php" class="text-black">Senior UX Designer</a></h2>
											...
											<div class="d-flex col-xl-4 col-xxl-3 col-md-4 col-sm-6 mt-sm-0 mt-3 align-items-center">
												...
												<div>
													<h4 class="card-title--medium mb-1">London, England</h4>
													<span>Location</span>
												</div>
											</div>
											<div class="col-xl-4 col-md-3 col-sm-12 mt-md-0 mt-3  d-flex align-items-center justify-content-md-end justify-content-start">
												<a href="app-profile.php" class="btn btn-sm btn-outline-primary rounded me-2">Apply Now</a>
							...
							<div class="col-xl-12">
								<div class="card d-sm-flex flex-xl-column flex-md-row">
									<div class="card-body border-bottom text-center col-xl-12 col-md-6">
										...
										<a href="javascript:void(0);" class="btn btn-outline-primary d-block">+ Follow</a>
										<div class="row mt-5">
									...
									<div class="card-body col-xl-12 col-md-6 border-left ">
										...
										<div class="d-flex justify-content-between flex-wrap pt-3">
											<a href="javascript:void(0);" class="btn btn-primary btn-sm mb-2">23 Vacancy</a>
											<a href="javascript:void(0);" class="btn btn-dark  btn-sm mb-2">More Detail</a>
										</div>
									</div>
								</div>
							</div>
