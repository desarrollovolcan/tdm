 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(90, 69, 170,1))',
							borderWidth: "0",
							backgroundColor: 'rgba(90, 69, 170,1)',
							barPercentage: 0.5,
						}
					]
				},
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(90, 69, 170,1)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(90, 69, 170,1)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(90, 69, 170,1)',
							tension: 0.5,
						}
					]
				},
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(90, 69, 170,1)");
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(90, 69, 170,1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(90, 69, 170, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(253,83,83,1)', 
