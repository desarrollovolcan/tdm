                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="navpills-2" class="tab-pane">
                                        <div class="row">
                                            <div class="col-md-12"> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
                                        </div>
                                    </div>
                                    <div id="navpills-3" class="tab-pane">
                                        <div class="row">
                                            <div class="col-md-12"> There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
					...
					<div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="card-tabs">
									<ul class="nav nav-tabs d-inline-flex mb-4">
										<li class=" nav-item">
											<a href="#navpills2-11" class="nav-link active" data-bs-toggle="tab" aria-expanded="false">Tab One</a>
										</li>
										<li class="nav-item">
											<a href="#navpills2-21" class="nav-link" data-bs-toggle="tab" aria-expanded="false">Tab Two</a>
										</li>
										<li class="nav-item">
											<a href="#navpills2-31" class="nav-link" data-bs-toggle="tab" aria-expanded="true">Tab Three</a>
										</li>
									</ul>
								</div>
                                <div class="tab-content">
                                    <div id="navpills2-11" class="tab-pane active">
                                        <div class="row">
                                            <div class="col-md-12"> Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.
                                                <p>
                                                    <br> Reprehenderit butcher retro keffiyeh dreamcatcher synth.ex squid.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="navpills2-21" class="tab-pane">
                                        <div class="row">
                                            <div class="col-md-12"> Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.
                                                <p>
                                                    <br> Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    ...
                                    <div id="navpills2-31" class="tab-pane">
                                        <div class="row">
                                            <div class="col-md-12"> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Earum, maiores est aliquid perferendis facere libero animi recusandae quibusdam obcaecati, nihil quaerat. Hic eius asperiores impedit labore aut, blanditiis fugit quia?.
                                                <p>
                                                    <br> Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                            </div>
                                        </div>
