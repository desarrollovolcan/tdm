							...
							<div class="card-body">
                                <div class="slider-disabled ">
                                    ...
                                    <div class="form-check custom-checkbox checkbox-primary me-3">
										...
										<label class="form-check-label form-label" for="checkbox1">Disable handle 1</label>
									</div>
                                </div>
                            </div>
                        </div>
							...
							<div class="card-body">
                                <div class="slider-disabled ">
                                    ...
                                    <div class="form-check custom-checkbox checkbox-primary  me-3">
										...
										<label class="form-check-label form-label" for="checkbox2">Disable handle 1</label>
									</div>
									<div class="form-check custom-checkbox checkbox-primary  me-3">
										<input type="checkbox" class="form-check-input" id="checkbox3" required="">
										<label class="form-check-label form-label" for="checkbox3">Disable handle 1</label>
									</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
							...
							<div class="card-body">
                                <div class="locked-slider">
                                    ...
                                    <button class="btn btn-danger btn-sm mt-4" id="lockbutton" style="float: right; margin: 20px 0 0;">Lock</button>
                                </div>
                            </div>
                        </div>
                    </div>
