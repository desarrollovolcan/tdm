                                                ...
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        ...
                                                                        <span class="fs-14 text-muted">Gestiona fichas, datos médicos y elegibilidad de jugadores</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Gestiona fichas, datos médicos y elegibilidad de jugadores</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
