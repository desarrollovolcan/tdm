                                                ...
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        ...
                                                                        <span class="fs-14 text-muted">Consulta el cronograma y estado de cada torneo programado</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Consulta el cronograma y estado de cada torneo programado</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
