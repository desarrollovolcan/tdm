                                        ...
                                        <div class="col-xl-12">
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        <h4 class="fs-20 mb-1">Ranking y categorías</h4>
                                                                        <span class="fs-14 text-muted">Actualiza el ranking y las categorías por edad o nivel</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Actualiza el ranking y las categorías por edad o nivel</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
