                                        ...
                                        <div class="col-xl-12">
                                                <div class="card">
                                                        <div class="card-header d-sm-flex d-block border-0 pb-0">
                                                                <div>
                                                                        <h4 class="fs-20 mb-1">Actas y exportables</h4>
                                                                        <span class="fs-14 text-muted">Genera actas oficiales y exporta información a Excel o PDF</span>
                                                                </div>
                                                        </div>
                                                        <div class="card-body">
                                                                <p class="mb-0">Genera actas oficiales y exporta información a Excel o PDF</p>
                                                        </div>
                                                </div>
                                        </div>
                                </div>
